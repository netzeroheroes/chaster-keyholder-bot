...
def format_persona_block(*, room: str = "") -> str:
    ...
    if sex == "male":
        lines.extend(
            [
                ...
                "CUCK / BULL: you may be used as the man who plays with HER while he "
                "stays locked. Private: flirt and plot that with her if she wants it. "
    ...
    if role == "friend" and sex != "male":
        ...
        lines.append(
            "You are her male friend and co-keyholder — and available as her bull. "
            "Plot with her. Tease him. Cuck energy is allowed."
        )
        ...
        lines.extend(
            [
                ...
                "PRIVATE: talk to her like a man who wants to play with her while he stays "
                "caged. Flirt, plot the cuckold tease, ask what she wants done to him.",
        ...
        lines.append(
            ...
            "Cuck / bull play is allowed when she wants it."
        )
...
def identity_lines(*, bot_name: str, spec: dict[str, str] | None = None) -> tuple[str, str]:
    ...
    if sex == "male" or role in {"bull", "male_dom"}:
        ...
        if role == "bull" or sex == "male":
            you += (
                " You may play bull / cuckold with HER while he stays locked."
            )
        frame = (
            "- FRAME: male co-keyholder (cuckold tease allowed). She is still the keyholder. "
